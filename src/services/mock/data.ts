...
export const MOCK_ORDERS: Order[] = [
  {
    ...
    item_name_snapshot: 'Học phí Học kỳ I - Lớp 11A1 (THPT Chuyên Công Nghệ Schoolify)',
  ...
  },
  {
    ...
    reference_id: 'crs-01',
    item_name_snapshot: 'Toán Học 11: Chuyên Đề Lượng Giác & Xác Suất Thống Kê',
    item_price_snapshot: 499000,
    payment_method: 'BANK',
    status: 'PAID',
  ...
  },
  {
    ...
    item_name_snapshot: 'Gia hạn Gói SaaS Growth Academy (12 Tháng)',
    item_price_snapshot: 46800000,
    payment_method: 'BANK',
    status: 'PAID',
...
export const MOCK_QUESTION_BANKS: QuestionBank[] = [
  {
    ...
    department_name: 'Tổ Toán & Tin Học',
    grade_level: 'Lớp 12',
    chapter_name: 'Chương 1: Hàm số lượng giác',
    is_premium: true,
    status: 'APPROVED',
    subject: 'Toán học',
  ...
  },
  {
    ...
    department_name: 'Tổ Toán & Tin Học',
    grade_level: 'Lớp 12',
    chapter_name: 'Chương 3: Nguyên hàm và tích phân',
    is_premium: false,
    status: 'PENDING',
    subject: 'Toán học',
  ...
  {
    id: 'bank-toan1-phep-cong',
    title: 'Ngân hàng Toán 1 – Phép cộng trong phạm vi 10',
    owner_id: 'tchr-01',
    school_id: 'sch-01',
    teacher_name: 'ThS. Nguyễn Văn Hùng',
    department_name: 'Tổ Toán & Tin Học',
    grade_level: 'Lớp 1',
    chapter_name: 'Chương 2: Phép cộng trong phạm vi 10',
    is_premium: false,
    status: 'PENDING',
    description: 'Bộ câu hỏi nền tảng để kiểm tra nhận biết và thực hiện phép cộng trong phạm vi 10.',
    questions_count: 2,
    count_used: 0,
    ...
    questions: [
      {
        id: 'qk-l1-01',
        bank_id: 'bank-toan1-phep-cong',
        type: 'SINGLE_CHOICE',
        title: 'Tính nhẩm',
        content: 'Kết quả của phép tính 3 + 4 là:',
        points: 1,
        created_at: '2026-09-12T08:10:00Z',
        answers: [
          { id: 'qk-l1-01-a1', question_id: 'qk-l1-01', content: '6', is_answer: false },
          { id: 'qk-l1-01-a2', question_id: 'qk-l1-01', content: '7', is_answer: true, explain: 'Gộp 3 que tính với 4 que tính được 7 que tính.' },
          { id: 'qk-l1-01-a3', question_id: 'qk-l1-01', content: '8', is_answer: false },
        ],
      },
      {
        id: 'qk-l1-02',
        bank_id: 'bank-toan1-phep-cong',
        type: 'TRUE_FALSE',
        title: 'Nhận biết phép cộng',
        content: 'Khẳng định sau đúng hay sai: 5 + 0 = 5.',
        points: 1,
        created_at: '2026-09-12T08:15:00Z',
        answers: [
          { id: 'qk-l1-02-a1', question_id: 'qk-l1-02', content: 'Đúng', is_answer: true, explain: 'Cộng với 0 thì số ban đầu không thay đổi.' },
          { id: 'qk-l1-02-a2', question_id: 'qk-l1-02', content: 'Sai', is_answer: false },
        ],
      },
    ],
  },
